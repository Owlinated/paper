...
class Euler:
   ...
   def copy(self):
      '''Returns a copy of this euler.
         ...
         @returns (Euler): A copy of the euler.
   ...
   def to_matrix(self):
      '''Return a matrix representation of the euler.
         ...
         @returns (Matrix): A 3x3 roation matrix representation of the euler.
      '''
   ...
   def to_quaternion(self):
      '''Return a quaternion representation of the euler.
         ...
         @returns (Quaternion): Quaternion representation of the euler.
      '''
...
class Matrix:
   ...
   def OrthoProjection(axis, size):
      '''Create a matrix to represent an orthographic projection.
         ...
         @returns (Matrix): A new projection matrix.
      '''
   ...
   def Rotation(angle, size, axis):
      '''Create a matrix representing a rotation.
         ...
         @returns (Matrix): A new rotation matrix.
      '''
   ...
   def Scale(factor, size, axis):
      '''Create a matrix representing a scaling.
         ...
         @returns (Matrix): A new scale matrix.
      '''
   ...
   def Shear(plane, size, factor):
      '''Create a matrix to represent an shear transformation.
         ...
         @returns (Matrix): A new shear matrix.
      '''
   ...
   def Translation(vector):
      '''Create a matrix representing a translation.
         ...
         @returns (Matrix): An identity matrix with a translation.
      '''
   ...
   def adjugated(self):
      '''Return an adjugated copy of the matrix.
         ...
         @returns (Matrix): the adjugated matrix.
   ...
   def copy(self):
      '''Returns a copy of this matrix.
         ...
         @returns (Matrix): an instance of itself
      '''
   ...
   def inverted(fallback=None):
      '''Return an inverted copy of the matrix.
         ...
         @returns (Matrix): the inverted matrix or fallback when given.
      '''
   ...
   def normalized(self):
      '''Return a column normalized matrix
         ...
         @returns (Matrix): a column normalized matrix
      '''
   ...
   def to_euler(order, euler_compat):
      '''Return an Euler representation of the rotation matrix
         ...
         @returns (Euler): Euler representation of the matrix.
      '''
   ...
   def to_quaternion(self):
      '''Return a quaternion representation of the rotation matrix.
         ...
         @returns (Quaternion): Quaternion representation of the rotation matrix.
      '''
   ...
   def to_scale(self):
      '''Return the scale part of a 3x3 or 4x4 matrix.
         ...
         @returns (Vector): Return the scale of a matrix.
   ...
   def to_translation(self):
      '''Return the translation part of a 4 row matrix.
         ...
         @returns (Vector): Return the translation of a matrix.
      '''
   ...
   def transposed(self):
      '''Return a new, transposed matrix.
         ...
         @returns (Matrix): a transposed matrix
      '''
...
class Quaternion:
   ...
   def copy(self):
      '''Returns a copy of this quaternion.
         ...
         @returns (Quaternion): A copy of the quaternion.
   ...
   def cross(other):
      '''Return the cross product of this quaternion and another.
         ...
         @returns (Quaternion): The cross product.
      '''
   ...
   def dot(other):
      '''Return the dot product of this quaternion and another.
         ...
         @returns (Quaternion): The dot product.
      '''
   ...
   def inverted(self):
      '''Return a new, inverted quaternion.
         ...
         @returns (Quaternion): the inverted value.
      '''
   ...
   def normalized(self):
      '''Return a new normalized quaternion.
         ...
         @returns (Quaternion): a normalized copy.
      '''
   ...
   def rotation_difference(other):
      '''Returns a quaternion representing the rotational difference.
         ...
         @returns (Quaternion): the rotational difference between the two quat rotations.
      '''
   ...
   def slerp(other, factor):
      '''Returns the interpolation of two quaternions.
         ...
         @returns (Quaternion): The interpolated rotation.
      '''
   ...
   def to_euler(order, euler_compat):
      '''Return Euler representation of the quaternion.
         ...
         @returns (Euler): Euler representation of the quaternion.
      '''
   ...
   def to_matrix(self):
      '''Return a matrix representation of the quaternion.
         ...
         @returns (Matrix): A 3x3 rotation matrix representation of the quaternion.
      '''
...
class Vector:
   ...
   def Repeat(vector, size):
      '''Create a vector by repeating the values in vector until the required size is reached.
         ...
         Arguments:
         @tuple (Vector): The vector to draw values from.
         @size (int): The size of the vector to be created.
   ...
   def dot(other):
      '''Return the dot product of this vector and another.
         ...
         @returns (Vector): The dot product.
      '''
   ...
   def orthogonal(self):
      '''Return a perpendicular vector.
         ...
         @returns (Vector): a new vector 90 degrees from this vector.
   ...
   def project(other):
      '''Return the projection of this vector onto the *other*.
         ...
         @returns (Vector): the parallel projection vector
      '''
   ...
   def reflect(mirror):
      '''Return the reflection vector from the *mirror* argument.
         ...
         @returns (Vector): The reflected vector matching the size of this vector.
      '''
   ...
   def rotation_difference(other):
      '''Returns a quaternion representing the rotational difference between this
         ...
         @returns (Quaternion): the rotational difference between the two vectors.
   ...
   def to_track_quat(track, up):
      '''Return a quaternion rotation from the vector and the track and up axis.
         ...
         @returns (Quaternion): rotation from the vector and the track and up axis.
      '''
